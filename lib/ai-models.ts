...
export const aiModels: AIModel[] = [
  ...
  // ==========================================
  { id: "nv-deepseek-v4-flash", name: "DeepSeek V4 Flash", company: "DeepSeek", size: "284B", provider: "nvidia", endpoint: "deepseek/v4-flash", alias: "deepseek-ai/deepseek-v4-flash", status: "FREE", badge: "Reasoning" },
  { id: "nv-deepseek-v4-pro", name: "DeepSeek V4 Pro", company: "DeepSeek", size: "1.6T MoE", provider: "nvidia", endpoint: "deepseek/v4-pro", alias: "deepseek-ai/deepseek-v4-pro", status: "FREE", badge: "Frontier" },
  { id: "nv-mistral-small-4", name: "Mistral Small 4", company: "Mistral", size: "119B", provider: "nvidia", endpoint: "mistral/small-4", alias: "mistralai/mistral-small-4-119b-2603", status: "FREE", badge: "Balanced" },
  { id: "nv-ministral-14b-instruct", name: "Ministral 14B Instruct", company: "Mistral", size: "14B", provider: "nvidia", endpoint: "mistral/ministral-14b", alias: "mistralai/ministral-14b-instruct-2512", status: "FREE", badge: "Fast" },
  { id: "nv-mixtral-8x7b-instruct", name: "Mixtral 8x7B Instruct", company: "Mistral", size: "47B MoE", provider: "nvidia", endpoint: "mistral/mixtral-8x7b", alias: "mistralai/mixtral-8x7b-instruct-v0.1", status: "FREE", badge: "General" },
  { id: "nv-nemotron-3-super", name: "Nemotron-3 Super", company: "NVIDIA", size: "120B", provider: "nvidia", endpoint: "nvidia/nemotron-3-super", alias: "nvidia/nemotron-3-super-120b-a12b", status: "FREE", badge: "Reasoning" },
  { id: "nv-nemotron-3-ultra", name: "Nemotron-3 Ultra", company: "NVIDIA", size: "550B", provider: "nvidia", endpoint: "nvidia/nemotron-3-ultra", alias: "nvidia/nemotron-3-ultra-550b-a55b", status: "FREE", badge: "Agentic" },
  { id: "nv-gemma-4", name: "Gemma 4", company: "Google", size: "31B IT", provider: "nvidia", endpoint: "google/gemma-4", alias: "google/gemma-4-31b-it", status: "FREE", badge: "Thinking" },
  { id: "nv-qwen-3-5", name: "Qwen 3.5", company: "Alibaba", size: "122B", provider: "nvidia", endpoint: "alibaba/qwen-3-5", alias: "qwen/qwen3.5-122b-a10b", status: "FREE", badge: "Coding" },
  { id: "nv-minimax-m2-7", name: "MiniMax M2.7", company: "MiniMax", size: "M2.7", provider: "nvidia", endpoint: "minimax/m2-7", alias: "minimaxai/minimax-m2.7", status: "FREE", badge: "General" },
  { id: "nv-phi-4-mini-instruct", name: "Phi-4 Mini Instruct", company: "Microsoft", size: "3.8B", provider: "nvidia", endpoint: "microsoft/phi-4-mini", alias: "microsoft/phi-4-mini-instruct", status: "FREE", badge: "Edge" },
  { id: "nv-llama-3-3", name: "Llama 3.3", company: "Meta", size: "70B Instruct", provider: "nvidia", endpoint: "meta/llama-3-3", alias: "meta/llama-3.3-70b-instruct", status: "FREE", badge: "Balanced" },
  { id: "nv-step-3-7-flash", name: "Step-3.7 Flash", company: "StepFun", size: "Flash", provider: "nvidia", endpoint: "stepfun/step-3-7-flash", alias: "stepfun-ai/step-3.7-flash", status: "FREE", badge: "Fast" },
  { id: "nv-kimi-k2-6", name: "Kimi K2.6", company: "Moonshot", size: "K2.6", provider: "nvidia", endpoint: "moonshot/kimi-k2-6", alias: "moonshotai/kimi-k2.6", status: "FREE", badge: "Chat" },
  { id: "nv-gpt-oss-20b", name: "GPT-OSS 20B", company: "OpenAI", size: "20B", provider: "nvidia", endpoint: "openai/gpt-oss-20b", alias: "openai/gpt-oss-20b", status: "FREE", badge: "Local" },
  { id: "nv-gpt-oss-120b", name: "GPT-OSS 120B", company: "OpenAI", size: "120B", provider: "nvidia", endpoint: "openai/gpt-oss-120b", alias: "openai/gpt-oss-120b", status: "FREE", badge: "Reasoning" },
  { id: "nv-seed-oss-36b-instruct", name: "Seed-OSS 36B Instruct", company: "ByteDance", size: "36B", provider: "nvidia", endpoint: "bytedance/seed-oss-36b", alias: "bytedance/seed-oss-36b-instruct", status: "FREE", badge: "General" },
